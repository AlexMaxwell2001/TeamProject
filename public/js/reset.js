  ...
  //Verify the email is related to an existing account 
  function getEmails(){
      const Http= new XMLHttpRequest();
      var input=document.getElementById('emailInput').value;
      const url= "/Reset/emails/"+ input;
      Http.open("GET",url);
      Http.send();
  ...
  $.ajax({
                ...
                url:  updateForm.attr('action')+"/"+email + "/" + newPassword,
  ...
  $('#emailInput').on('keyup',function(){
    if(emailInput.value.length>0){
      ...
      document.getElementById('button1').style.background="rgb(231, 238, 236)";
      document.getElementById('button1').style.color="rgb(137, 152, 155)";
      document.getElementById('button1').disabled=true;
  ...
  $('#Input2').on('keyup',function(){
    if(Input2.value.length>0){
      ...
      document.getElementById('button2').disabled=true;
      document.getElementById('button2').style.background="rgb(231, 238, 236)";
      document.getElementById('button2').style.color="rgb(137, 152, 155)";
  ...
  $('#Input3').on('keyup',function(){
    if(Input3.value.length>0){
      ...
      document.getElementById('button3').disabled=true;
      document.getElementById('button3').style.background="rgb(231, 238, 236)";
      document.getElementById('button3').style.color="rgb(137, 152, 155)";
  ...
  $('#button1').on('click',function(){
      ...
      const url= "/Reset/send/"+rand + "/" + input;
      Http.open("GET",url);
      Http.send();
  });

  $('#button3').on('click',function(){
       var code=document.getElementById('Input3').value;
       if(code == rand){
