    ...
    //If the forgot password link is clicked bring the user to the reset page
    ...
    //When continuing show the password field and other stuff
    $("#continue").on('click', function(){
      document.getElementById('Password').style.visibility="visible";
      document.getElementById('signin').style.visibility="visible";
      document.getElementById('Username').style.background="rgb(232, 240, 254)";
      document.getElementById('Username').style.cursor="default";
      document.getElementById('continue').style.visibility="hidden";
      document.getElementById('label3').style.visibility="visible";
      document.getElementById('label4').style.top="220px";
      document.getElementById('resetLink').style.visibility="visible";
    })

    //Don't let the user submit their username if it's empty
    $("#Username").on('keyup', function(){
      if(document.getElementById('Username').value.length>0){
        document.getElementById('continue').style.background="green";
        document.getElementById('continue').style.border="green";
        document.getElementById('continue').style.color="white";
        document.getElementById('continue').disabled=false;
        document.getElementById('continue').style.cursor="pointer";
        //For testing to allow the login be available to test
        /*document.getElementById('signin').style.background="green";
        document.getElementById('signin').style.border="green";
        document.getElementById('signin').style.color="white";
        document.getElementById('signin').disabled=false;
        document.getElementById('signin').style.cursor="pointer";*/
      }
      else{
        document.getElementById('continue').style.background="rgb(231, 238, 236)";
         document.getElementById('continue').style.border="rgb(231, 238, 236)";
        document.getElementById('continue').style.color="rgb(137, 152, 155)";
        document.getElementById('continue').disabled=true;
        document.getElementById('continue').style.cursor="default";
        document.getElementById('signin').style.background="rgb(231, 238, 236)";
         document.getElementById('signin').style.border="rgb(231, 238, 236)";
        document.getElementById('signin').style.color="rgb(137, 152, 155)";
        document.getElementById('signin').disabled=true;
        document.getElementById('signin').style.cursor="default";
      }
    ...
    //Don't let the user submit their password if it's empty
    ...
    //Verifying that the password belongs to the account Username provided
    function passwordVerification(){
        ...
        Http.onreadystatechange=function(){
            if(Http.responseText.length>2){
                ...
                var ar =Http.responseText.split("Password");
                var newar=ar[1].split(":");
                var result=newar[1].split(",");
                var dbpassword=result[0];
                dbpassword = dbpassword.replace(/"/g,"");
                var encrypted=btoa(input+" " +password);
                if(password === dbpassword){
                  document.getElementById('warning2').style.visibility="hidden";
                  $('#successAlert').modal('show');
                  document.getElementById("tester").innerHTML="Success";
                  var timer = setTimeout(function() {
                    $(location).attr('href', '/'+encrypted+'/'+'login=true')}, 3000);
                }else{
