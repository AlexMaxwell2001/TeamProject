    ...
    $("#all").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName');
        } 
        else{
    ...
    $("#skirts").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/skirt');
        } 
        else{
    ...
    $("#bags").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/bag');
        } 
        else{
    ...
    $("#tshirts").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/t-shirt');
        } 
        else{
    ...
    $("#shoes").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/shoe');
        } 
        else{
    ...
    $("#hoodies").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/hoodie');
        } 
        else{
    ...
    $("#jeans").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/jean');
        } 
        else{
    ...
    $("#coats").on('click',function() {
        ...
        var manip=attempt.substring(0,attempt.indexOf("/"));
        if (ar.includes('true')) {
            $(location).attr('href', '/' +manip+'/login=true/Products/ProductName/coat');
        } 
        else{
    ...
    function findSpec(value){
        $(location).attr('href', window.location.href+'/fullView/'+value);
    };
    ...
    //if logged in show logout and no login option
    ...
    //This checks whether someone has tampered with the url and put in a false login
    $(document).ready(function(){
    ...
    //this will check if the search had any results
    $(document).ready(function(){
        const Http= new XMLHttpRequest();
