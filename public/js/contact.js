    ...
    document.getElementById('Join').style.cursor="default";

    //Get current URL
    var current= window.location;

    //This function is for registration, if the user is successfully register a pop-up shows
	var addForm = $("#addForm");
    ...
    $(".form-control").on('keyup',function() {
        ...
        if(!flag){
            ...
            document.getElementById('Join').disabled=true;
            document.getElementById('Join').style.cursor="cursor";
        }
    })
    ...
    function findSpecific(value){
        ...
        if(ar.includes("true")){
            if(n=="T-shirts"){
                n="t-shirt";$(location).attr('href', '/' +manip+'/login=true/Products/ProductName/'+n);
            }
            else if(n=="Bags"){
                n="bag";
